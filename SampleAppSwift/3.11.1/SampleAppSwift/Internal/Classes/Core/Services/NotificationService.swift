...
class NotificationService: BaseService {
    ...
    private func setCategories() {
        ...
        let testOk = UNNotificationAction(identifier: "test_ok", title: "OK", options: UNNotificationActionOptions.foreground)
        let testCancel = UNNotificationAction(identifier: "test_cancel", title: "Cancel", options: UNNotificationActionOptions.destructive)
        
        let testCategory = UNNotificationCategory(identifier: "test_category", actions: [testOk, testCancel], intentIdentifiers: [], options: [])
        
        UNUserNotificationCenter.current().setNotificationCategories([singleMediaCategory, carouselCategory, testCategory])
    }
