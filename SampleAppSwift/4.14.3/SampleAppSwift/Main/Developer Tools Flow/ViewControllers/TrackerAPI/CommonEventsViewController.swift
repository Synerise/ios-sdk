...
class CommonEventsViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 15 && indexPath.row == 0 { sendRecommendationViewEvent() }
        if indexPath.section == 16 && indexPath.row == 0 { sendRecommendationSeenEvent() }
        if indexPath.section == 17 && indexPath.row == 0 { sendRecommendationClickEvent() }
    ...
    private func sendRecommendationViewEvent() {
